...
public class BeamUtils {
    ...
    public static BukkitTask createBeam(Player player, double distance, int loopsPerTick, FluidCollisionMode fluidCollisionMode, BiConsumer<MutableInt, Location> action, Predicate<Entity> targetable, Runnable cleanup, boolean defaultBeam, Color color) {
        ...
        return Bukkit.getScheduler().runTaskTimer(OwlCraft.getInstance(), () -> {
            for (int i = 0; i < loopsPerTick && !stop.getValue(); i++) {
                runnable.run();
            }
        }, 0, 1);
    }
     ...
     * @param color              What color default beam?
     */
    public static void createBeam(Player player, double distance, FluidCollisionMode fluidCollisionMode, TriConsumer<BukkitTask, MutableInt, Location> action, Predicate<Entity> targetable, Runnable cleanup, boolean defaultBeam, Color color) {
        createBeam(player, distance, 1, fluidCollisionMode, action, targetable, cleanup, defaultBeam, color);
    }
     ...
     * @param color       What color default beam?
     */
    public static void createBeam(Player player, double distance, TriConsumer<BukkitTask, MutableInt, Location> action, Predicate<Entity> targetable, Runnable cleanup, boolean defaultBeam, Color color) {
        createBeam(player, distance, 1, FluidCollisionMode.NEVER, action, targetable, cleanup, defaultBeam, color);
    }
     ...
     * @param color       What color default beam?
     */
    public static void createBeam(Player player, double distance, TriConsumer<BukkitTask, MutableInt, Location> action, Runnable cleanup, boolean defaultBeam, Color color) {
        createBeam(player, distance, 1, FluidCollisionMode.NEVER, action, null, cleanup, defaultBeam, color);
    }
     ...
     * @param color       What color default beam?
     */
    public static void createBeam(Player player, double distance, TriConsumer<BukkitTask, MutableInt, Location> action, boolean defaultBeam, Color color) {
        createBeam(player, distance, 1, FluidCollisionMode.NEVER, action, null, null, defaultBeam, color);
    }
     ...
     * @param color    What color default beam?
     */
    public static void createBeam(Player player, double distance, TriConsumer<BukkitTask, MutableInt, Location> action, Runnable cleanup, Color color) {
        createBeam(player, distance, 1, FluidCollisionMode.NEVER, action, null, cleanup, true, color);
    }
     ...
     * @param color      What color default beam?
     */
    public static void createBeam(Player player, double distance, TriConsumer<BukkitTask, MutableInt, Location> action, Predicate<Entity> targetable, Color color) {
        createBeam(player, distance, 1, FluidCollisionMode.NEVER, action, targetable, null, true, color);
    }
     ...
     * @param color    What color default beam?
     */
    public static void createBeam(Player player, double distance, TriConsumer<BukkitTask, MutableInt, Location> action, Color color) {
        createBeam(player, distance, 1, FluidCollisionMode.NEVER, action, null, null, true, color);
    }
     ...
     * @param color        What color default beam?
     */
    public static void createBeam(Player player, double distance, int loopsPerTick, TriConsumer<BukkitTask, MutableInt, Location> action, Runnable cleanup, Color color) {
        createBeam(player, distance, loopsPerTick, FluidCollisionMode.NEVER, action, null, cleanup, true, color);
    }
     ...
     * @param color              What color default beam?
     */
    public static void createBeam(Player player, double distance, int loopsPerTick, FluidCollisionMode fluidCollisionMode, TriConsumer<BukkitTask, MutableInt, Location> action, Predicate<Entity> targetable, Runnable cleanup, boolean defaultBeam, Color color) {
        Location src = player.getLocation();
        Vector direction = src.getDirection();
        Vector velocity = player.getVelocity();
        if ((velocity.getX() != 0.0) || (velocity.getZ() != 0.0)) {
